...
\begin{frame}{Evaluation Results}
  ...
  \begin{tabular}{lr}
    ...
    OpenRouter smoke test & passed with gpt-oss-20b free \\
    Equal-weight cumulative return & 4.77\% \\
    Decision-weighted cumulative return & 8.65\% \\
    Worst stress scenario & tech drawdown, -7.46\% \\
    \bottomrule
  \end{tabular}
  \end{center}
  \vspace{0.5em}
...
\end{verbatim}
    ...
    \item Open generated outputs:
      \begin{itemize}
        \item \texttt{reports/dataset\_validation.md}
        \item \texttt{reports/benchmark\_results.md}
...
\begin{frame}{Engineering Deliverables}
  \begin{itemize}
    ...
    \item Reports: dataset validation, benchmark summaries, stress tests, and static HTML dashboard.
...
\begin{frame}{Limitations and Next Steps}
  \begin{itemize}
    ...
    \item The decision-weighted backtest is simplified and does not model transaction costs or market impact.
    \item Next steps: richer demo video, broader stock universe, cached real-data adapters, and more realistic execution modeling.
  \end{itemize}
\end{frame}

\begin{frame}{Takeaway}
  \begin{block}{Final outcome}
    The project has moved from a minimal prototype to an above-proposal applied-track deliverable: runnable system, fixed benchmark, baselines, validation, dynamic backtest, stress tests, generated reports, final report, and presentation slides.
  \end{block}
\end{frame}
